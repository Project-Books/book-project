...
//        List<Long> authorIds = authorService.findAll().stream()
//                .map(BaseEntity::getId)
//                .filter(id -> id.equals(book.getAuthor().getId()))
//                .collect(Collectors.toList());
//
//        if (authorIds.size() == 1) {
//            LOGGER.log(Level.INFO, "Matching authorIds: " + authorIds);
//			book.getAuthor().removeId();
//        }
