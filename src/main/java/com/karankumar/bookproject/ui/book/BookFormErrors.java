...
public class BookFormErrors {
    ...
    public static final String FINISH_DATE_ERROR = "The date you finished reading the book cannot be earlier than the date you started reading the book";
    public static final String AFTER_TODAY_ERROR = "The date you %s reading the book cannot be after today's date.";
}
