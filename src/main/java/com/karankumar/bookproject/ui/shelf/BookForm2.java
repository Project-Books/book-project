 ...
 */
public class BookForm2 extends VerticalLayout {
    ...
    private static final Logger LOGGER = Logger.getLogger(BookForm2.class.getName());
    private final Dialog dialog;

    public BookForm2(PredefinedShelfService shelfService) {
    ...
    // Events
    public static abstract class BookFormEvent extends ComponentEvent<BookForm2> {
        private Book book;

        protected BookFormEvent(BookForm2 source, Book book) {
            super(source, false);
            this.book = book;
        }
    ...
    public static class SaveEvent extends BookFormEvent {
        SaveEvent(BookForm2 source, Book book) {
            super(source, book);
        }
    }

    public static class DeleteEvent extends BookFormEvent {
        DeleteEvent(BookForm2 source, Book book) {
            super(source, book);
        }
    }
