...
Questions and feedback should be discussed over Slack. This allows others to benefit from seeing the answers, too.

For ideas, please vote on an existing [GitHub idea discussion](https://github.com/Project-Books/book-project/discussions/categories/ideas). If the idea has not been suggested, feel free to create a new discussion.
